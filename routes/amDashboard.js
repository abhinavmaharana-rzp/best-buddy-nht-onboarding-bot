...
function createRouter(app) {
    ...
    async function sendOnboardingPlan(app, userId, userDetails) {
        try {
            ...
            const selectedOnboardingData = subFunction === 'Channel' ? channelOnboardingData : amOnboardingData;
    ...
    /**
     * @swagger
     * /am-dashboard/overview:
     *   get:
     *     summary: Get AM dashboard overview statistics
     *     tags: [AM Dashboard]
     *     security:
     *       - bearerAuth: []
     */
     ...
     * /am-dashboard/users:
     *   get:
     *     summary: Get all AM users with their progress
     *     tags: [AM Dashboard]
     *     security:
     *       - bearerAuth: []
     */
    ...
    /**
     * @swagger
     * /am-dashboard/approvals:
     *   get:
     *     summary: Get all AM approval requests with details
     *     tags: [AM Dashboard]
     *     security:
     *       - bearerAuth: []
     */
    ...
    /**
     * @swagger
     * /am-dashboard/user/{userId}:
     *   get:
     *     summary: Get detailed information for a specific AM user
     *     tags: [AM Dashboard]
     *     security:
     *       - bearerAuth: []
     */
    ...
    /**
     * @swagger
     * /am-dashboard/trigger-onboarding:
     *   post:
     *     summary: Trigger AM onboarding plan for a user
     *     tags: [AM Dashboard]
     *     security:
     *       - bearerAuth: []
     */
