    ...
    days: [
      ...
      },
      {
        ...
        events: [
          ...
          { title: 'Process (BEST) and SOP', owner: 'Team SPOC',link: '', mode: 'Video + In-Person' },
        ],
      },
    ],
  },
  {
    ...
    days: [
      ...
      },
      {
        ...
        time: '2:30 PM - 6:00 PM',
        events: [
          { title: 'Process (CS)', owner: 'Team SPOC',link: '', mode: 'Video + In-Person' },
          { title: 'Buddy Meet', owner: 'Buddy',link: '', mode: 'In-Person' },
          { title: 'Process (Finops / Settlements) and SOP', owner: 'Team SPOC',link: '', mode: 'Video + In-Person' },
        ],
      },
    ],
  },
    ...
    days: [
      ...
      },
      {
        ...
        events: [
          { title: 'Task for the Day', owner: 'Self / L&D',link: '', mode: 'In-Person' },
          { title: 'Buddy Meet', owner: 'Buddy', link: '', mode: 'In-Person' },
          { title: 'Process (Risk) and SOP', owner: 'Team SPOC',link: '', mode: 'Video + In-Person' },
        ],
      },
    ],
  },
